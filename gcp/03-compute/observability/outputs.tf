...
output "grafana_url" {
  description = "The internal domain URL to instantly access your Grafana dashboards securely"
  value       = "http://grafana.${data.google_dns_managed_zone.private_zone.dns_name}:3000"
}
